                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('anggota.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" class="form-control" id="text" placeholder="Enter Nama Anggota">
                        </div>
                        <div class="form-group">
                            <label for="jabatan">Jabatan</label>
                            <input type="text" name="jabatan" class="form-control" id="text" placeholder="Enter Jabatan Anggota">
                        </div>
                        <div class="form-group">
                            <label for="deskripsi">Deskripsi</label>
                            <textarea name="body" id="text" class="form-control" placeholder="Isi dengan biodata anda"></textarea>
                        </div>
                        <div class="form-group">
